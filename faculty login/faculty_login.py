...
<center>
    <h1>faculty Login</h1>
        <div class="login-container">
            <div class="card">
                <div class="card-body">
                    <form id="loginForm" action="faculty_login.py" method="post" enctype="multipart/form-data">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="forgotPasswordForm" action="fac_forgot_password.py" method="post">
          <div class="form-group">
...
sub = f.getvalue("sub")
if sub != None:
    q1 = """select * from faculty where username='%s' and password='%s'""" % (uname, pwd)
    cur.execute(q1)
    r = cur.fetchone()

    if r != None:
        print("""<script>location.href="faculty_home.py?id=%s";</script>""" % (r[0]))
    else:
        print("""<script>alert("Invalid Username or password... ");location.href="faculty_login.py";</script>""")
conn.close()
