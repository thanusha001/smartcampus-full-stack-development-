...
q = """SELECT * FROM student WHERE mailid='%s'""" % email
cur.execute(q)
result = cur.fetchone()
...
if result:
    ...
    print("""<script>alert('email has been sent...');location.href='student_login.py';</script>""")
    ...
    print("""<script>alert('email not found...');location.href='student_login.py';</script>""")
    # print("Content-type:text/html\r\n\r\n")
    # print("<html>")
    # print("<head>")
    # print("<title>Password Recovery</title>")
